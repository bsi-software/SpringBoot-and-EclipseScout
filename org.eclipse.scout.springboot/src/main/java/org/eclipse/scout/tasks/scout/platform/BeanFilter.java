...
/**
 * BeanFilter to replace Scout's default bean filter. Why do we need this? Scout's default bean filter skips bean
 * classes without a no args constructor. This means that the Desktop class of this app would not be considered a valid
 * bean. BeanFilter is used in {@link ScoutSpringPlatform}}
 */
